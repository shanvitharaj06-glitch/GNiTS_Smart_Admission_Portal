...
/* IMAGE PATHS */
$photo = !empty($_SESSION['photo']) ? $base . "oci_uploads/" . $_SESSION['photo'] : "";
$stud_sign = !empty($_SESSION['stud_sign']) ? $base . "oci_uploads/" . $_SESSION['stud_sign'] : "";
$parent_sign = !empty($_SESSION['parent_sign']) ? $base . "oci_uploads/" . $_SESSION['parent_sign'] : "";
...
<td width="60%" align="center">
    ...
    <h4 style="margin:5px 0;">OCI ADMISSION FORM</h4>
</td>
...
<tr><td>10th</td><td>'.(!empty($_SESSION['ssc']) ? 'Yes' : 'No').'</td></tr>
<tr><td>12th</td><td>'.(!empty($_SESSION['inter']) ? 'Yes' : 'No').'</td></tr>
<tr><td>Passport of Student</td><td>'.(!empty($_SESSION['passport']) ? 'Yes' : 'No').'</td></tr>
<tr><td>Adress Proof</td><td>'.(!empty($_SESSION['address_proof']) ? 'Yes' : 'No').'</td></tr>
