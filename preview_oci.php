...
$_SESSION['ssc'] = temp($_FILES['ssc'], "doc");
$_SESSION['inter'] = temp($_FILES['inter'], "doc");
$_SESSION['passport'] = temp($_FILES['passport'], "doc");
$_SESSION['address_proof'] = temp($_FILES['address_proof'], "doc");
...
<tr>
    ...
    <td><?= !empty($_SESSION['ssc']) ? "Yes" : "No" ?></td>
</tr>
...
<tr>
    ...
    <td><?= !empty($_SESSION['address_proof']) ? "Yes" : "No" ?></td>
</tr>
...
<form action="payments/payu_payment.php" method="POST" style="display:inline;">
    ...
    <form action="download_oci_pdf.php" method="POST">
