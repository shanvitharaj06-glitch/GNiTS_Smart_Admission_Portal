...
// FETCH STUDENT DATA
// ==========================
$stmt = $conn->prepare("SELECT * FROM nri WHERE id = ?");
...
<div style='font-family:Arial,sans-serif;line-height:1.6;'>
    ...
    <p>Your NRI application has been submitted successfully.</p>
...
// ==========================
if (sendMail($email, "NRI Application Submitted", $studentBody, [$pdf_file])) {
    echo "
    <script>
        alert('Mail resent successfully to $email');
        window.location.href='nri_list.php';
    </script>
    ";
} else {
