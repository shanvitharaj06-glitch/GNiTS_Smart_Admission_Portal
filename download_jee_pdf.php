...
/* BASE URL */
$base_path = "http://gnitscollege.in/uploads/";

// IMAGE PATHS
$base = "http://gnitscollege.in/";

/* IMAGE PATHS */
$photo = !empty($_SESSION['photo']) ? $base . "jee_uploads/" . $_SESSION['photo'] : "";
$stud_sign = !empty($_SESSION['stud_sign']) ? $base . "jee_uploads/" . $_SESSION['stud_sign'] : "";
$parent_sign = !empty($_SESSION['parent_sign']) ? $base . "jee_uploads/" . $_SESSION['parent_sign'] : "";
...
<td width="60%" align="center">
    ...
    <h4 style="margin:5px 0;">JEE ADMISSION FORM</h4>
</td>
...
<tr><td>JEE Rank Card</td><td>'.(!empty($_SESSION['jee_card']) ? 'Yes' : 'No').'</td></tr>
