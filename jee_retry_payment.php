...
$stmt = $conn->prepare("SELECT * FROM jee WHERE email = ? AND payment_status = 'Pending' LIMIT 1");
...
$update = $conn->prepare("UPDATE jee SET txnid = ?, payu_status = 'retry' WHERE id = ?");
...
$amount = "1";
$productinfo = "JEE Admission Fee";
$firstname = $user['name'];
$phone = $user['mobile'];

$surl = "http://gnitscollege.in/payu_success_jee.php";
$furl = "http://gnitscollege.in/jee_payment_fail.php";
