...
// 🧠 BASE QUERY
if($type == "merit"){
    $sql = "SELECT * FROM jee ORDER BY jee_rank ASC";
} else {
    $sql = "SELECT * FROM jee ORDER BY id DESC";
}
...
elseif($filter == "rejected"){
    $sql = "SELECT * FROM jee WHERE status='Rejected' ORDER BY jee_rank ASC";
}
elseif($filter == "pending"){
    $sql = "SELECT * FROM jee WHERE status='Pending' ORDER BY jee_rank ASC";
}
...
<html>
<head>
<title>GNITS - JEE Students</title>
...
<div class="controls single-line">
    ...
    <a href="jee_merit_list.php">MeritList Download</a>
    ...
    <!-- EXPORT -->
    <a href="export_pdf.php?type=jee">📄 PDF</a>
    <a href="export_excel.php?type=jee">📊 Excel</a>
...
<?php if($row['payment_status'] == "Paid"){ ?>
    ...
    <!-- ENABLED LINK -->
    <a href="jee_pdf.php?type=jee&id=<?= $row['id'] ?>">
        <?= $row['name'] ?>
    </a>
...
<?php } ?>
    ...
    <td>
<?php if($row['payment_status'] == "Paid"){ ?>
    <a href="resend_mail_jee.php?id=<?= $row['id'] ?>"
       class="resend-btn"
