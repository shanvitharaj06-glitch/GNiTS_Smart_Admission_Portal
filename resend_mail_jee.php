...
// FETCH STUDENT DATA
// ==========================
$stmt = $conn->prepare("SELECT * FROM jee WHERE id = ?");
...
<div style='font-family:Arial,sans-serif;line-height:1.6;'>
    ...
    <p>Your JEE application has been submitted successfully.</p>
...
// ==========================
if (sendMail($email, "JEE Application Submitted", $studentBody, [$pdf_file])) {
    echo "
    <script>
        alert('Mail resent successfully to $email');
        window.location.href='jee_list.php';
    </script>
    ";
} else {
