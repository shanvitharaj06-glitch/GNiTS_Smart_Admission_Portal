...
$stmt = $conn->prepare("SELECT * FROM nri WHERE email = ? AND payment_status = 'Pending' LIMIT 1");
...
$update = $conn->prepare("UPDATE nri SET txnid = ?, payu_status = 'retry' WHERE id = ?");
...
$surl = "http://gnitscollege.in/payu_success_nri.php";
$furl = "http://gnitscollege.in/nri_payment_fail.php";
