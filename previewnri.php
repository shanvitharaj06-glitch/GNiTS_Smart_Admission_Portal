...
function tempUpload($file, $folder)
{
    if (!empty($file['name'])) {
        ...
        $destination = "nri_uploads/" . $filename;
...
$_SESSION['passport'] = temp($_FILES['passport'], "doc");
$_SESSION['eamcet_card'] = temp($_FILES['eamcet_card'], "doc");
$_SESSION['nri_letter'] = temp($_FILES['nri_letter'], "doc");
$_SESSION['nri_driving'] = temp($_FILES['nri_driving'], "doc");
...
<tr>
    <td class="label">Passport/VISA</td>
    <td><?= !empty($_SESSION['passport']) ? "Yes" : "No" ?></td>
</tr>
...
<tr>
    <td class="label">NRI Sponsorship Letter</td>
    <td><?= !empty($_SESSION['nri_letter']) ? "Yes" : "No" ?></td>
</tr>

<tr>
    <td class="label">NRI Address Proof</td>
    <td><?= !empty($_SESSION['nri_driving']) ? "Yes" : "No" ?></td>
</tr>
</table>
...
<form action="payments/payu_payment.php" method="POST" style="display:inline;">
    <button type="submit" class="pay-btn">
        Confirm & Pay ₹1
    </button>
    </form>
    <form action="download_nri_pdf.php" method="POST">
